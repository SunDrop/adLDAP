...
class adLDAPContacts
{
     ...
     *
     * @param string $distinguishedName $distinguisedname The full DN of a contact
     ...
     * @return bool
     * @internal param string $distinguishedname The contact to mail enable
     * @internal param string $emailaddress The email address to allow emails to be sent through
     * @internal param string $mailnickname The mailnickname for the contact in Exchange.  If NULL this will be set to the display name
     */
